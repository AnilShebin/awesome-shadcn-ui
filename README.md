...
| nextjs-shadcn-marketing-boilerplates   | A modern Next.js boilerplate designed for creating responsive, pre-built UI blocks for marketing websites. It includes tools like React, TypeScript, Tailwind CSS, Shadcn/ui, and Radix UI, along with features like SEO optimization, API integration, and more.                           | [Link](https://nsui.irung.me)                                          |
